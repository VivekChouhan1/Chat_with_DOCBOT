...
from voice_of_doctor import text_to_speech_with_pyttsx3_new, text_to_speech_with_elevenlabs_new
...
#ye function hi sari process karke.. sabko coordinate karega and output dega
def process_inputs(audio_filepath, image_filepath):
    ...
    voice_of_doctor = text_to_speech_with_pyttsx3_new(input_text=doctor_response, output_filepath="final.mp3") 
